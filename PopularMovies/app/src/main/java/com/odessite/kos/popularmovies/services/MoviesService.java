package com.odessite.kos.popularmovies.services;
...
import com.odessite.kos.popularmovies.BuildConfig;
...
public class MoviesService extends IntentService {
    public static final String LANGUAGE_QUERY_EXTRA = "lqe";
    ...
    protected void onHandleIntent(Intent intent) {
        String lang = intent.getStringExtra(LANGUAGE_QUERY_EXTRA);
    ...
    private void getMoviesFromJson(String moviesDbDiscover, int page) throws JSONException{
        ...
        try {
            ...
            if (cVector.size() > 0){
                ...
                this.getContentResolver().bulkInsert(MovieContract.MovieEntry.CONTENT_URI, movieValues);
